...
<html lang="ca">
    ...
    <!-- Títol i Favicons -->
    <title>Agustí Roig | Nova factura</title>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline">
                                                    <h4>Nova factura</h4>
                                                    <span>Introdueix les dades del nou projecte a facturar.</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                        ...
                                        <div class="card col-sm-4">
                                            ...
                                            <div class="card-block">
                                                ...
                                                <form>
                                                    ...
                                                    <div class="form-row">
                                                        <label class="col-sm-3 col-form-label">Import</label>
                                                    ...
                                                    <div class="form-row">
                                                        <label class="col-sm-3 col-form-label">Estat</label>
