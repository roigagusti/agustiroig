...
<html lang="ca">
    ...
    <!-- Títol i Favicons -->
    <title>Agustí Roig | Ofertes</title>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline">
                                                    <h4>Ofertes</h4>
                                                    <span>Es mostren totes les ofertes que s'ha generat.</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card-header">
                                                <a href="nova-oferta.php" class="btn btn-primary waves-effect waves-light add">Nova oferta</a>
                                            </div>
                                                    ...
                                                    <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th scope="col" class="numero">Preu</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $ofertes = $database->select("ofertes", ["id","numero","data","preu","estat"]);
                                                            foreach($ofertes as $data){
                                                            ?>
                                                            <tr>
                                                                <th scope="row"><?php echo $data['id'];?></th>
                                                                <td class="numero"><?php echo "PH_".$data['numero'];?></td>
                                                                <td class="numero"><?php echo $data['data'];?></td>
                                                                <td class="numero"><?php echo number_format($data['preu'],2);?>€</td>
                                                                <td class="numero"><?php echo number_format($data['preu']*0.85,2);?>€</td>
